...
export default async function Footer() {
  ...
  return (
    <footer className="background-light900_dark200 light-border dark:shadow-none">
        ...
        >
          {navigation.main.map((item) => (
            <div key={item.name} className="pb-6">
              <Link
                href={item.href}
                className="text-dark100_light900 hover:text-dark200_light800 text-sm leading-6"
              >
                {item.name}
              </Link>
            </div>
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {navigation.social.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              className="text-dark100_light900 hover:text-dark200_light800"
            >
